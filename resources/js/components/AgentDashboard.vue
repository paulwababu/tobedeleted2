    ...
    <div>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        <h5 class="card-title mb-0 text-center">Agent Account Analytics</h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 col-xxl-8">
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Rent Payment Stats</h5>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col mt-0">
                                        <h5 class="card-title">Total Units/ Houses</h5>
                                    </div>
